...
// Those objects -- per node deployments/services/pvcs and the big per topology configmap --
...
// no longer vanish with the last Topology (standalone Nodes need them too).
