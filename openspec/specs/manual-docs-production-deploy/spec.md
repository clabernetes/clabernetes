# manual-docs-production-deploy Specification

## Purpose

Allow maintainers to publish production documentation from the default branch outside the release cycle, using a shared reusable deploy workflow with the release pipeline.
