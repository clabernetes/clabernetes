# crd-viewer Specification

## Purpose

Interactive CRD schema reference in the documentation site: parse controller CRD YAML, render collapsible field trees with permalinks, and embed via MDX.
