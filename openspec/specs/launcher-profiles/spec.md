...
### Requirement: LauncherProfile controls direct device Pod affinity
...
- **WHEN** multiple Nodes in one namespace reference the same LauncherProfile containing
...
- **THEN** the shared direct device Pod uses the primary Node's resolved LauncherProfile affinity
