...
The site SHALL render repository-owned Markdown or MDX as navigable documentation with a landing page, quickstart, architecture and core concepts, guides, examples, and API reference sections. Core-concept navigation SHALL present Node and Link as the primary API and SHALL describe Topology as a supported higher-level compatibility resource.

#### Scenario: Navigate the primary API documentation

- **WHEN** a reader opens the core concepts section
...
- **THEN** the existing architecture, guide, example, and CRD reference material is reachable through stable site routes
