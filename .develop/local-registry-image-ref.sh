...
# Print a localhost:<node-port>/... image reference for the in-cluster DevSpace registry.
# Used by the local-registry profile so Helm and dev pods pull images the build script pushed.
