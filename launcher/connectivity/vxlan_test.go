...
func TestUpdateVxlanTunnelsCommitsCurrentState(t *testing.T) {
	...
	err = manager.updateVxlanTunnels([]*clabernetesapisv1alpha1.PointToPointTunnel{initial})
	if err != nil {
		t.Fatal(err)
	}
	...
	err = manager.updateVxlanTunnels([]*clabernetesapisv1alpha1.PointToPointTunnel{changed})
	if err != nil {
		t.Fatal(err)
	}
...
func TestUpdateVxlanTunnelsKeepsRetryableStateOnFailure(t *testing.T) {
	...
	manager.currentTunnels = map[string]*clabernetesapisv1alpha1.PointToPointTunnel{}
...
func testTunnel(destination string, tunnelID int) *clabernetesapisv1alpha1.PointToPointTunnel {
